...
@section('content')
    <form class="row g-3" method="POST" action="{{ route('user.store') }}">
        ...
        <div class="col-md-4 mb-3 disabled">
            ...
            <input type="email" class="form-control disabled" id="inputEmail3" value="{{old('email')}}" name="email" autofocus>
            @error('email')
        ...
        <div id="passwordCreate" class="password input-group mb-3 col-md-4">
